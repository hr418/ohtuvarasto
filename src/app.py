...
def add_warehouse():  # pylint: disable=too-many-statements
    """Add a new warehouse."""
    if request.method == 'POST':
        ...
        try:
            ...
            flash('Virheellinen syöte! Tarkista arvot.', 'error')
...
def _update_warehouse(warehouse_id):  # pylint: disable=too-many-statements
...
def add_content(warehouse_id):
    ...
    try:
        ...
        flash('Virheellinen syöte! Tarkista arvo.', 'error')
        return redirect(url_for('index'))
